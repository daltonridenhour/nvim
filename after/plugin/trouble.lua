...
vim.keymap.set("n", "<leader>ee", "<cmd>TroubleToggle<cr>", { silent = true, noremap = true })
...
vim.keymap.set("n", "<leader>eq", "<cmd>TroubleToggle quickfix<cr>", { silent = true, noremap = true })
